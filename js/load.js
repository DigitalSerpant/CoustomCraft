const el = document.getElementById('filler'); setTimeout(() => { el.style.visibility = 'visible'; }, 5000); function loadGame() {
    ...
    function openGame(url) {
      ...
      win.document.write('<!DOCTYPE html><html><head><title>Classlink</title></head><body style="margin: 0; padding: 0;">');
      win.document.write('<iframe src="' + url + '" frameborder="0" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%;"></iframe>');
